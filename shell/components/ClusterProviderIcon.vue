...
<template>
  ...
  >
    ...
    <svg  v-else-if="cluster.isLocal && !cluster.isHarvester" class="cluster-local-logo" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="20995" xmlns:xlink="http://www.w3.org/1999/xlink" width="32" height="32"><path d="M899.6 90.6H124.4c-32.9 0-59.6 26.7-59.6 59.6v89.5c0 32.9 26.7 59.6 59.6 59.6h775.3c32.9 0 59.6-26.7 59.6-59.6v-89.5c0-32.9-26.7-59.6-59.7-59.6zM197.4 239.7c-24.7 0-44.7-20-44.7-44.7s20-44.7 44.7-44.7 44.7 20 44.7 44.7-20 44.7-44.7 44.7zM899.6 407.6H124.4c-32.9 0-59.6 26.7-59.6 59.6v89.5c0 32.9 26.7 59.6 59.6 59.6h775.3c32.9 0 59.6-26.7 59.6-59.6v-89.5c0-32.9-26.7-59.6-59.7-59.6zM197.4 556.7c-24.7 0-44.7-20-44.7-44.7 0-24.7 20-44.7 44.7-44.7s44.7 20 44.7 44.7c0.1 24.7-20 44.7-44.7 44.7zM899.6 724.7H124.4c-32.9 0-59.6 26.7-59.6 59.6v89.5c0 32.9 26.7 59.6 59.6 59.6h775.3c32.9 0 59.6-26.7 59.6-59.6v-89.5c0-32.9-26.7-59.6-59.7-59.6zM197.4 873.8c-24.7 0-44.7-20-44.7-44.7 0-24.7 20-44.7 44.7-44.7s44.7 20 44.7 44.7c0.1 24.7-20 44.7-44.7 44.7z" class="rancher-icon-fill"></path></svg>
    <!-- eslint-enable -->
    <img
